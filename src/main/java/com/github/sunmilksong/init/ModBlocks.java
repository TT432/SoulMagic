...
public class ModBlocks {
    ...
    public static final BlockTransparent SOLID_STATE_SOUL = new
            BlockTransparent("solid_state_soul", Material.IRON, SoundType.GLASS);

    public static final BlockFarm SOUL_SAND = new
            BlockFarm("soul_sand", Material.SAND, SoundType.SAND);
    /**
     * <p>挖掘等级
     * <p>level 0是木/金
     * <p>level 1是石
    ...
    public static final BlockOre SOLID_ORE = new
            BlockOre("soul_ore", "pickaxe", 2, 0.5f, Material.ROCK, SoundType.STONE);
    /**
     * 作物
     */
